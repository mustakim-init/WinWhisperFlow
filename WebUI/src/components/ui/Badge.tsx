  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-[11px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        success:
          'border-transparent bg-emerald-500/15 text-emerald-400 border-emerald-500/30 hover:bg-emerald-500/20',
        warning:
          'border-transparent bg-amber-500/15 text-amber-400 border-amber-500/30 hover:bg-amber-500/20',
      },
    },
    defaultVariants: {
      variant: 'default',
