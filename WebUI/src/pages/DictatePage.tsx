    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center border border-dashed border-border/80 rounded-xl text-sm text-muted-foreground select-none gap-4 p-8">
        ...
        <span className="text-xs text-center max-w-xs">
          ...
          Go to the <span className="font-medium">Models</span> page and download <span className="font-medium">Demucs Source Separator</span> under Tools.
        </span>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full min-h-0 relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 pb-4 px-2 pointer-events-none">
        <div className="pointer-events-auto mx-auto max-w-2xl rounded-2xl border border-border bg-card/90 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] px-5 py-3.5">
          <div className="flex items-center gap-3">
            {/* Action button */}
            <div className="flex items-center gap-2 shrink-0">
              {activeTab === 'voice' ? (
                ...
                <Button
                  ...
                  disabled={store.modelLoading || store.fileTranscribing}
                  className="shrink-0 gap-2 text-sm h-9"
                >
                  <Upload size={15} />
            ...
            {/* Loading spinner */}
            {store.modelLoading && (
              <div className="flex items-center gap-1.5 text-xs bg-accent/10 text-accent rounded-full px-3 py-1 shrink-0">
